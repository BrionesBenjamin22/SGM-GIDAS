...
class TrabajoRevistaMemoriaHistorialTestCase(unittest.TestCase):
    ...
    def test_snapshot_trabajo_revista_para_memoria_version_persiste_foto(self):
        ...
        with patch(
            "modules.produccion.services.trabajo_revista_service.TrabajosRevistasReferato",
            new=SimpleNamespace(
                query=fake_query,
    ...
    def test_obtener_historial_trabajo_revista_retorna_auditoria_ordenada(self):
        ...
        with patch(
            "modules.produccion.services.trabajo_revista_service.db.session.get",
    ...
    def test_obtener_snapshots_trabajo_revista_por_memoria_version(self):
        ...
        with patch(
            "modules.produccion.services.trabajo_revista_service.TrabajosRevistasReferatoMemoriaVersion",
            new=SimpleNamespace(
                query=fake_query,
